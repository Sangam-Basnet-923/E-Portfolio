...
function demoConditionals() {
    ...
    if (isNaN(age)) {
        output.innerHTML = '<div class="alert alert-warning">Please enter a valid age.</div>';
        return;
    }
...
function revealCards() {
    const cards = document.querySelectorAll('.component-card, .element-card, .css-topic-card, .bootstrap-topic-card, .js-topic-card');
...
document.querySelectorAll('#fullstack, #html, #css, #bootstrap, #javascript').forEach(section => {
...
console.log('%c Welcome to Sangam Basnet\'s Portfolio! ', 'background: #ff6b35; color: white; font-size: 20px; padding: 10px;');
console.log('%c CET138 Full Stack Development ePortfolio ', 'background: #ff8c42; color: white; font-size: 14px; padding: 5px;');
